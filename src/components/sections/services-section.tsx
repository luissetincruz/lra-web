      ...
      <Container>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2 lg:mt-16 lg:grid-cols-3">
          {services.map((service) => (
            <article
              key={service.code}
              className="flex min-h-full flex-col rounded-3xl border border-light-border bg-background p-6 shadow-card-light transition-[border-color,box-shadow] duration-200 hover:border-brand/30 hover:shadow-[0_20px_60px_rgb(15_23_42_/_10%)] sm:p-7"
            >
